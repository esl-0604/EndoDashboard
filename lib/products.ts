        ...
        papers: [
          ...
          },
          {
            ...
            keyClaims: [
              ...
              "Mean dissection 48.2 mm²/min · 28.8 min mean procedure time",
              "No perforations · no device malfunctions",
            ],
            comparison: {
            ...
            abstract: "Single-arm prospective pilot of ROBOPERA-assisted gastric ESD in 15 consecutive patients. All patients achieved en bloc and R0 resection (100%). Mean total procedure time was 28.8 minutes; median robot-assisted dissection time 14.3 minutes; mean dissection speed 48.2 mm²/min, exceeding the proficiency benchmark of 15 mm²/min. Specimen injury occurred in 4 cases (26.7%). No perforations and no ROBOPERA device malfunctions were reported.",
            ...
            clinical: {
              ...
              enBloc: "100% (15/15)",
              r0: "100% (15/15)",
              procedureTime: "28.8 min (mean total)",
              dissectionSpeed: "48.2 mm²/min (mean)",
              complications: "0 perforations; specimen injury in 4 cases (26.7%)",
              notes: "Median robot-assisted dissection time 14.3 min; no ROBOPERA device malfunctions",
            },
          },
          {
            ...
            keyClaims: [
              "39% shorter procedure at challenging locations",
              "2.16× faster dissection (220.3 vs 101.9 mm²/min)",
              "50% fewer blind dissections (17.6% vs 35.2%)",
              "Demonstrated on a gastric ESD simulator",
            ],
            comparison: {
            ...
            abstract: "Comparative study of ROBOPERA-assisted ESD (RESD) versus conventional ESD (CESD) by trainee endoscopists on a gastric simulator. At a challenging anatomical location, RESD was faster than CESD (procedure time 6.2 vs 10.2 min, P<0.05) with higher dissection speed (220.3 vs 101.9 mm²/min, P<0.05) and a lower blind dissection rate (17.6% vs 35.2%, P<0.05). Robot-assisted ESD significantly reduced technical difficulty at challenging locations for trainees.",
            doi: "10.1007/s00464-024-10743-9",
            url: "https://doi.org/10.1007/s00464-024-10743-9",
            clinical: {
              patients: "Simulator-based study (gastric ESD by trainee endoscopists)",
              procedureTime: "RESD 6.2 min vs CESD 10.2 min at challenging location (P<0.05)",
              dissectionSpeed: "RESD 220.3 vs CESD 101.9 mm²/min at challenging location (P<0.05)",
              notes: "Blind dissection rate 17.6% (RESD) vs 35.2% (CESD) at challenging location, P<0.05",
            },
          },
          {
            ...
            highlight: { big: "Novices ≈ Experts", label: "Dissection Speed Gap Closed", sub: "with robotic assistance" },
            keyClaims: [
              "Novice dissection speed reached expert level",
              "16 gastric lesions resected in 9 live pigs",
              "No complications reported in any group",
              "Robotic assistance benefits novice operators",
            ],
            abstract: "In vivo feasibility study of a detachable robotic traction device for gastric ESD performed by experienced (n=2) and novice (n=2) endoscopists in 9 live pigs (16 lesions). Submucosal incision speed was significantly faster in the expert group than in the novice group (P=0.002). However, there was no significant difference in submucosal dissection speed between the groups (P=0.365), indicating novice dissection speed approached expert level with robotic assistance. No complications were reported in either group.",
            doi: "10.1007/s00464-021-08510-1",
            url: "https://doi.org/10.1007/s00464-021-08510-1",
            clinical: {
              patients: "16 lesions in 9 live pigs (2 experts, 2 novices)",
              complications: "No complications in either group",
              notes: "Incision speed significantly faster in experts (P=0.002); no significant dissection-speed difference between experts and novices (P=0.365) — robotic assistance enabled novices to approach expert dissection level",
            },
          },
          {
        ...
        papers: [
          {
            ...
            keyClaims: [
              ...
              "1.72× faster dissection (157.6 vs 91.4 mm²/min)",
              "100% complete closure vs 66.6% with conventional",
              "Superior wound healing (narrower epithelial absence)",
            ],
            comparison: {
            ...
            abstract: "Comparative study of ROBOPERA-TraCloser-assisted ESD (RESD) versus conventional ESD (CESD) on 24 gastric lesions in 6 live pigs. RESD achieved significantly shorter procedure times (10.2±1.7 vs 15.8±2.1 min, P<0.05) and faster dissection speeds (157.6±33.3 vs 91.4±23.7 mm²/min). Complete defect closure was achieved in 100% of RESD cases versus 66.6% of CESD cases. The RESD group also exhibited fewer clip requirements and superior wound healing (narrower zones of epithelial absence and reduced neovascular and fibroblast infiltration). All lesions were resected without adverse events.",
            ...
            clinical: {
              patients: "24 gastric lesions in 6 live pigs",
              procedureTime: "RESD 10.2±1.7 min vs CESD 15.8±2.1 min (P<0.05)",
              dissectionSpeed: "RESD 157.6±33.3 vs CESD 91.4±23.7 mm²/min",
              complications: "0 adverse events in both groups",
              notes: "Complete defect closure 100% (RESD) vs 66.6% (CESD); fewer clip requirements and superior histologic healing (narrower epithelial absence zones, reduced neovascular and fibroblast infiltration)",
            },
          },
          {
